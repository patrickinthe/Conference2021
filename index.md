...
## 서면결의서를 내고 싶어요!  
서면결의서를 [다운](/서면결의서.pdf)받으셔서 작성([작성방법](/how1.PNG), [작성방법(공동명의인데, 대표자 없는경우)](/how2.PNG)]) 후, 연락 주세요![010-6418-8281](tel:01064188281)    
<br />
<br />
...
>  박정근이 전문관리인이 될지이야기가 많아 **조합원 여러분들께서 판단 및 의견을 주실 수 있도록, 추천 여부를 안건에 추가**하였습니다.  
>  이 안건이 **부결되더라도, 나머지 안건이 전부 가결되면 빠른등기에는 문제가 없습니다.**  
>  찬성(박정근이 빠른 등기내고 추분 줄이는데 적임자다)와 반대(박정근 못 믿겠고 싫다, 다른사람 원한다) 중 선택 가능합니다.  
>  전문조합관리인은 구청이 선임 및 해임권을 가지고 있습니다. **추천이 많다고 해서 중구청에서 반드시 선임하는 것은 아닙니다.**  
>  **이 총회는 조합원 여러분께 가장 빨리 등기낼 기회를 마련하고자 함이며, 박정근을 전문관리인에 적합하지 않다고 판단하셔도 좋습니다.**  
...
>  일부러 인건비를 12개월치만 의결해 빠른 조합 해산을 유도하고, 청산시에는 추분이 나오지 않도록 하기 위함입니다.
>  자세한 내용은(링크)[https://cafe.naver.com/seosenzxi/179]를 참조 하세요.
